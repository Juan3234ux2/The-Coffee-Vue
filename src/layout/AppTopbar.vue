...
const getGreeting = () => {
    ...
    if (currentHour > 6 && currentHour <= 13) return 'Buenos días';
...
<template>
    <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            ...
            >
                <span class="font-bold text-black">The Coffee</span>
            </router-link>
        ...
        <div class="flex flex-col" v-if="!layoutState.staticMenuDesktopInactive">
            <p class="text-primary font-bold !m-0" style="font-size: 1.2rem">
                {{ store.currentGym?.nombre }}
                {{ getGreeting() }}, {{ store.getUserLogged?.name }}
            </p>
